...
const GraphScreen = ({ navigation, route }) => {
  ...
  const removeFavourite = () => {
    ...
    category === "Overall"
      ? userCopy.favouriteGraphs.overall = user.favouriteGraphs.overall.filter(graph => graph != type)
      : category === "TargetMuscle"
      ? userCopy.favouriteGraphs.targetMuscle = user.favouriteGraphs.targetMuscle.filter(graph => graph != type)
      : userCopy.favouriteGraphs.exercise = user.favouriteGraphs.exercise.filter(graph => graph != type)
